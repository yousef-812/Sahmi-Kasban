...
_REPETITIVE_SENTENCES = (
    ...
    "التصنيف تحليلي تجريبي ولا يضمن التفوق على السوق أو تحقيق ربح.",
    "حتى الفرص النخبوية قد تتعرض لتذبذب وهبوط مؤقت؛ التزم بوقف الخسارة وحجم المركز ولا تعتبر التصنيف ضمانًا للربح.",
    "أفق ترتيب التقرير خمس جلسات تداول؛ أما الدخول ووقف الخسارة والهدفان فهي خطة تداول ممتدة وقد تحتاج مدة أطول.",
    "فرصة نخبوية اجتازت ترتيب اليوم ودرجة الاتجاه وبوابات Core v2.2 للتمدد السعري والتذبذب والمخاطر وانتظام التداول.",
    "إشارة شراء جيدة، لكنها لم تجتز جميع بوابات الفرصة النخبوية الخاصة بالتمدد والمخاطر وجودة الحركة؛ راقب شروط الدخول.",
    "الخاصة بالتمدد والمخاطر وجودة الحركة؛ راقب شروط الدخول.",
    "إشارة شراء جيدة، لكنها لم تجتز مسارًا كاملًا من مساري الفرصة النخبوية؛ راقب الاختراق والتذبذب والسيولة وشروط الدخول.",
    "اختيار نخبوى ضمن أعلى ترتيب يومي وبدرجة لا تقل عن 80. التقييم القصير يتابع خمس جلسات، وليس وعدًا بتحقيق أهداف السعر.",
    "الفرص الأعلى ترتيبًا قد تحقق حركة أكبر، لكنها قد تتعرض أيضًا لتذبذب وهبوط مؤقت أقوى؛ التزم بوقف الخسارة وحجم المركز.",
    "إشارة شراء مشروطة ضمن أفضل ترتيب اليوم، لكنها ليست ضمن طبقة الفرص النخبوية المثبتة بالدرجة. راقب شروط الدخول والمخاطر.",
)
