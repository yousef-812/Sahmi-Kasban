...
_EGX_BANK_TICKERS = {
    "COMI", "ADIB", "HDBK", "CIEB", "QNBE", "EXPA", "SAIB", "NBKE",
    "CANA", "EGBE", "SAUD", "FAIT", "FAITA", "CBKD"
}

_EXPLICIT_TICKER_SECTOR_MAP: dict[str, str] = {
    # البنوك
    "COMI": "البنوك", "ADIB": "البنوك", "HDBK": "البنوك", "CIEB": "البنوك",
    "QNBE": "البنوك", "EXPA": "البنوك", "SAIB": "البنوك", "NBKE": "البنوك",
    "CANA": "البنوك", "EGBE": "البنوك", "SAUD": "البنوك", "FAIT": "البنوك",
    "FAITA": "البنوك", "CBKD": "البنوك",
    # العقارات
    "TMGH": "العقارات", "PHDC": "العقارات", "HELI": "العقارات", "EMFD": "العقارات",
    "SODI": "العقارات", "ORHD": "العقارات", "EGTS": "العقارات", "OCDI": "العقارات",
    "RREI": "العقارات", "EHDR": "العقارات", "ACAP": "العقارات", "AREH": "العقارات",
    "ARAB": "العقارات", "CCRS": "العقارات", "DAPH": "العقارات", "IDRE": "العقارات",
    "KORA": "العقارات", "MAAL": "العقارات", "MASR": "العقارات", "MOED": "العقارات",
    "NARE": "العقارات", "ODIN": "العقارات", "ROTO": "العقارات", "UEGC": "العقارات",
    "UNIT": "العقارات", "UPMS": "العقارات", "UTOP": "العقارات",
    # الخدمات المالية
    "HRHO": "الخدمات المالية", "FWRY": "الخدمات المالية", "CCAP": "الخدمات المالية",
    "RAYA": "الخدمات المالية", "BTFH": "الخدمات المالية", "CICH": "الخدمات المالية",
    "BINV": "الخدمات المالية", "CNFN": "الخدمات المالية", "EFIH": "الخدمات المالية",
    "VALU": "الخدمات المالية", "AIFI": "الخدمات المالية", "AIH": "الخدمات المالية",
    "BONY": "الخدمات المالية", "CFGH": "الخدمات المالية", "GDWA": "الخدمات المالية",
    "GIHD": "الخدمات المالية", "GRCA": "الخدمات المالية", "OFH": "الخدمات المالية",
    "OIH": "الخدمات المالية", "PIOH": "الخدمات المالية", "PRMH": "الخدمات المالية",
    "RKAZ": "الخدمات المالية", "SDTI": "الخدمات المالية", "TYCN": "الخدمات المالية",
    # الأغذية والمشروبات
    "JUFO": "الأغذية والمشروبات", "OLFI": "الأغذية والمشروبات", "EAST": "الأغذية والمشروبات",
    "DOMT": "الأغذية والمشروبات", "GOUR": "الأغذية والمشروبات", "SUGR": "الأغذية والمشروبات",
    "EFID": "الأغذية والمشروبات", "ISMA": "الأغذية والمشروبات", "POUL": "الأغذية والمشروبات",
    "AJWA": "الأغذية والمشروبات", "AFDI": "الأغذية والمشروبات", "AFMC": "الأغذية والمشروبات",
    "AMER": "الأغذية والمشروبات", "BIDI": "الأغذية والمشروبات", "COSG": "الأغذية والمشروبات",
    "DTPP": "الأغذية والمشروبات", "EASB": "الأغذية والمشروبات", "EBSC": "الأغذية والمشروبات",
    "EGWA": "الأغذية والمشروبات", "INFI": "الأغذية والمشروبات", "ISMQ": "الأغذية والمشروبات",
    "LKGP": "الأغذية والمشروبات", "MBEG": "الأغذية والمشروبات", "MILS": "الأغذية والمشروبات",
    "MITR": "الأغذية والمشروبات", "MPCO": "الأغذية والمشروبات", "NEDA": "الأغذية والمشروبات",
    "SNFC": "الأغذية والمشروبات", "UEFM": "الأغذية والمشروبات", "WATP": "الأغذية والمشروبات",
    # الكيماويات
    "KIMA": "الكيماويات", "MFPC": "الكيماويات", "ABUK": "الكيماويات", "SKPC": "الكيماويات",
    "AMOC": "الكيماويات", "SIDM": "الكيماويات", "EFIC": "الكيماويات", "PACH": "الكيماويات",
    "AALR": "الكيماويات", "ACAMD": "الكيماويات", "BIOC": "الكيماويات", "CPCI": "الكيماويات",
    "EGCH": "الكيماويات", "ICID": "الكيماويات", "MICH": "الكيماويات", "MPCI": "الكيماويات",
    "NCGC": "الكيماويات", "NFCI": "الكيماويات", "NIPH": "الكيماويات", "SIPC": "الكيماويات",
    "SMFR": "الكيماويات", "ZEOT": "الكيماويات",
    # موارد أساسية
    "EGAL": "موارد أساسية", "ESRS": "موارد أساسية", "IRON": "موارد أساسية",
    "ALUM": "موارد أساسية", "SPMD": "موارد أساسية", "ASCM": "موارد أساسية",
    "ANCC": "موارد أساسية", "DCRC": "موارد أساسية", "IRAX": "موارد أساسية",
    "LCSW": "موارد أساسية", "SCFM": "موارد أساسية", "SINA": "موارد أساسية",
    "SVCE": "موارد أساسية",
    # الرعاية الصحية
    "CLHO": "الرعاية الصحية", "PHAR": "الرعاية الصحية", "RMDA": "الرعاية الصحية",
    "ISPH": "الرعاية الصحية", "EITP": "الرعاية الصحية", "ADCI": "الرعاية الصحية",
    "AXPH": "الرعاية الصحية", "CEFM": "الرعاية الصحية", "CERA": "الرعاية الصحية",
    "CID": "الرعاية الصحية", "EPCO": "الرعاية الصحية", "FCMD": "الرعاية الصحية",
    "MCRO": "الرعاية الصحية", "MEPA": "الرعاية الصحية", "MIPH": "الرعاية الصحية",
    "OBRI": "الرعاية الصحية", "OCPH": "الرعاية الصحية", "SPHT": "الرعاية الصحية",
    # الاتصالات والتكنولوجيا
    "ETEL": "الاتصالات والتكنولوجيا", "ORAS": "الاتصالات والتكنولوجيا",
    "SWDY": "الاتصالات والتكنولوجيا", "GTWL": "الاتصالات والتكنولوجيا",
    "ELEC": "الاتصالات والتكنولوجيا", "AIDC": "الاتصالات والتكنولوجيا",
    "ENGC": "الاتصالات والتكنولوجيا", "FTNS": "الاتصالات والتكنولوجيا",
    "HAEX": "الاتصالات والتكنولوجيا", "HAVC": "الاتصالات والتكنولوجيا",
    "HBCO": "الاتصالات والتكنولوجيا", "ICFC": "الاتصالات والتكنولوجيا",
    "IEEC": "الاتصالات والتكنولوجيا", "INEG": "الاتصالات والتكنولوجيا",
    "MOIL": "الاتصالات والتكنولوجيا", "NAHO": "الاتصالات والتكنولوجيا",
    "NCCW": "الاتصالات والتكنولوجيا", "TAQA": "الاتصالات والتكنولوجيا",
    # مواد البناء
    "ARCC": "مواد البناء", "SCEM": "مواد البناء", "MCQE": "مواد البناء",
    "TORA": "مواد البناء", "PRCL": "مواد البناء", "EALR": "مواد البناء",
    "ECAP": "مواد البناء", "EDFM": "مواد البناء", "EEP": "مواد البناء",
    "EFAC": "مواد البناء", "EGAS": "مواد البناء", "EGOTH": "مواد البناء",
    "EGREF": "مواد البناء", "ELAB": "مواد البناء", "ENPI": "مواد البناء",
    "EOSB": "مواد البناء", "GEOS": "مواد البناء",
    # مغاسل وغزل ونسيج
    "ORWE": "مغاسل وغزل ونسيج", "KABO": "مغاسل وغزل ونسيج", "UNIP": "مغاسل وغزل ونسيج",
    "SPIN": "مغاسل وغزل ونسيج", "GTEX": "مغاسل وغزل ونسيج", "ACFR": "مغاسل وغزل ونسيج",
    "ACGC": "مغاسل وغزل ونسيج", "AMIA": "مغاسل وغزل ونسيج", "AMII": "مغاسل وغزل ونسيج",
    "AMPI": "مغاسل وغزل ونسيج", "APSW": "مغاسل وغزل ونسيج", "DCCC": "مغاسل وغزل ونسيج",
    "EEII": "مغاسل وغزل ونسيج", "ELKA": "مغاسل وغزل ونسيج", "ELNA": "مغاسل وغزل ونسيج",
    "ELWA": "مغاسل وغزل ونسيج", "EPPK": "مغاسل وغزل ونسيج", "ETRS": "مغاسل وغزل ونسيج",
    "FIRE": "مغاسل وغزل ونسيج", "FNAR": "مغاسل وغزل ونسيج", "GGCC": "مغاسل وغزل ونسيج",
    "GGRN": "مغاسل وغزل ونسيج", "GPIM": "مغاسل وغزل ونسيج", "GPPL": "مغاسل وغزل ونسيج",
    "GSSC": "مغاسل وغزل ونسيج", "GTHE": "مغاسل وغزل ونسيج", "HDST": "مغاسل وغزل ونسيج",
    "IBCT": "مغاسل وغزل ونسيج", "ICLE": "مغاسل وغزل ونسيج", "IFAP": "مغاسل وغزل ونسيج",
    "KWIN": "مغاسل وغزل ونسيج", "KZPC": "مغاسل وغزل ونسيج", "LUTS": "مغاسل وغزل ونسيج",
    "MBSC": "مغاسل وغزل ونسيج", "MENA": "مغاسل وغزل ونسيج", "MFSC": "مغاسل وغزل ونسيج",
    "MHOT": "مغاسل وغزل ونسيج", "MISR": "مغاسل وغزل ونسيج", "MKIT": "مغاسل وغزل ونسيج",
    "MLIC": "مغاسل وغزل ونسيج", "MMAT": "مغاسل وغزل ونسيج", "MMHC": "مغاسل وغزل ونسيج",
    "MOIN": "مغاسل وغزل ونسيج", "MOSC": "مغاسل وغزل ونسيج", "MPRC": "مغاسل وغزل ونسيج",
    "NHPS": "مغاسل وغزل ونسيج", "NINH": "مغاسل وغزل ونسيج", "NMIN": "مغاسل وغزل ونسيج",
    "OCAP": "مغاسل وغزل ونسيج", "PHTV": "مغاسل وغزل ونسيج", "PMSC": "مغاسل وغزل ونسيج",
    "POCO": "مغاسل وغزل ونسيج", "PRDC": "مغاسل وغزل ونسيج", "RACC": "مغاسل وغزل ونسيج",
    "RAKT": "مغاسل وغزل ونسيج", "RMTV": "مغاسل وغزل ونسيج", "RUBX": "مغاسل وغزل ونسيج",
    "SACE": "مغاسل وغزل ونسيج", "SCTS": "مغاسل وغزل ونسيج", "SEIG": "مغاسل وغزل ونسيج",
    "SIEG": "مغاسل وغزل ونسيج", "SMPP": "مغاسل وغزل ونسيج", "SNFI": "مغاسل وغزل ونسيج",
    "TALM": "مغاسل وغزل ونسيج", "TANM": "مغاسل وغزل ونسيج", "TRTO": "مغاسل وغزل ونسيج",
    "TWSA": "مغاسل وغزل ونسيج", "UBEE": "مغاسل وغزل ونسيج", "VERT": "مغاسل وغزل ونسيج",
    "VLMR": "مغاسل وغزل ونسيج", "VLMRA": "مغاسل وغزل ونسيج", "WCDF": "مغاسل وغزل ونسيج",
    "WKOL": "مغاسل وغزل ونسيج", "YAYT": "مغاسل وغزل ونسيج", "ZMID": "مغاسل وغزل ونسيج",
}
