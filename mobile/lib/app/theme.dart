...
class SahmiTheme {
  ...
  static ThemeData _build(
    ColorScheme scheme, {
    required bool deepSpaceScaffold,
  }) {
    ...
    return base.copyWith(
      ...
      chipTheme: base.chipTheme.copyWith(
        backgroundColor: isDark ? SahmiBrand.carbon : SahmiBrand.lightSurface,
        side: BorderSide(color: SahmiBrand.glassBorder),
        labelStyle: base.textTheme.labelMedium?.copyWith(color: cs.onSurface),
      ),
