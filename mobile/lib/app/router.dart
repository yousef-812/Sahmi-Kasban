...
import '../features/admin/admin_stock_fingerprints_screen.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) =>
            StockNewsScreen(ticker: state.pathParameters['ticker']!),
      ),
      GoRoute(
        path: '/news',
      ...
      GoRoute(
        path: '/admin/stock-fingerprints',
        builder: (context, state) => const AdminStockFingerprintsScreen(),
      ),
      GoRoute(
        path: '/community/new',
